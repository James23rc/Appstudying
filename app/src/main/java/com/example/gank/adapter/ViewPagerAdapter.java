...
public class ViewPagerAdapter extends PagerAdapter implements ViewPager.OnPageChangeListener, View.OnClickListener{
    ...
    private void setDataToView() {
        ...
        for (int i = 0; i < PAGE; i++) {
            ...
            final int finalI = i;
            Glide.with(context).load(dataSource.get(index)).listener(new RequestListener<Drawable>() {
                @Override
                ...
                public boolean onResourceReady(Drawable resource, Object model, Target<Drawable> target, DataSource dataSource, boolean isFirstResource) {
                    ...
                    if (width > height){
                        views.get(finalI).setScaleType(ImageView.ScaleType.FIT_XY);
                    }else if (width <= height){
                        views.get(finalI).setScaleType(ImageView.ScaleType.FIT_CENTER);
                    }
                    return false;
                }
            }).into(views.get(i));
